    ...
    <header class="header">
        ...
        <div class="hero is-primary">
            <div class="hero-body">
                <div class="container">
                    <h1 class="title">
                        <a class="is-flex is-justify-content-flex-start is-align-items-center  is-gap-1 " href="https://github.com/modularavel/modularavel" target="_blank">
                            <img width="50px" src="https://avatars.githubusercontent.com/u/149928614?s=96&v=4" class="rounded-full" alt="Modularavel">
                            <span>Modularavel</span>
                        </a>
                    </h1>
                </div>
            </div>
...
@section('content')
    <div class="is-flex is-justify-content-center is-flex-direction-column is-gap-3.5">
        <div class="is-flex is-align-content-space-between is-align-items-center is-justify-content-space-between is-flex-direction-row is-gap-5">
            <div>
                <!-- Example of title -->
        ...
        <div>
            <div class="buttons">
                ...
                <button class="js-modal-trigger button is-large is-primary" data-target="modal-js-example">
                    Open JS example modal
                </button>
            </div>
        </div>
        <!-- End of buttons with icons -->

        <!-- Example of progress bars -->
        <div class="is-flex is-justify-content-center is-align-items-center is-flex-direction-column w-full">
            <progress class="progress is-small is-primary" max="100">15%</progress>
            <progress class="progress is-medium is-warning" max="100">75%</progress>
                        ...
                        <div class="card-content">
                            <div class="media">
                                <div class="media-left">
                                    <figure class="image is-48x48 is-rounded is-overflow-hiddens">
                                        <img
                                            src="https://images.unsplash.com/photo-1560298803-1d998f6b5249?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=4&w=256&h=256&q=80"
                                            alt="Placeholder image"
                                        />
                                    </figure>
                                </div>
                        ...
                        <div class="card-content">
                            <div class="media">
                                <div class="media-left">
                                    <figure class="image is-48x48 is-rounded is-overflow-hiddens">
                                        <img
                                            src="https://images.unsplash.com/photo-1598966739654-5e9a252d8c32?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=4&w=256&h=256&q=80"
                                            alt="Placeholder image"
                                        />
                                    </figure>
                                </div>
                        ...
                        <div class="card-content">
                            <div class="media">
                                <div class="media-left">
                                    <figure class="image is-48x48 is-rounded is-overflow-hiddens">
                                        <img
                                            src="https://images.unsplash.com/flagged/photo-1570612861542-284f4c12e75f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=4&w=256&h=256&q=80"
                                            alt="Placeholder image"
                                        />
                                    </figure>
                                </div>
